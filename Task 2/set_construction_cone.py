...
try:
    ...
    # This link provides the name of the default blueprint provided by CARLA. Check this page: https://carla.readthedocs.io/en/latest/bp_library/
    ...
    transform_2 = carla.Transform(carla.Location(x=-52, y=60, z=0))
    transform_3 = carla.Transform(carla.Location(x=-52, y=63, z=0))
